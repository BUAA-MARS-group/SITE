...
# For reproduction
s_evol = 0
s_subsumple = 0  # fixed seed for subsampling
random.seed(s_evol)
...
NUM_UNITS = 1  # length of dimension list

target_dimension = [0]

# %% Creating the primitives set
# Define the operators
host_pset = gep.PrimitiveSet('Host', input_names=['R_ij', 'P_ij', 'D_ij', 'delta_ij'])
...
output_type = f'RST_no_dhc'     # Name of the problem

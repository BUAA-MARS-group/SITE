...
import SITE
from simplification import p_symbol, linker_add
...
target_data = np.loadtxt('data/TecGrid-Cavity_Kn0.005_Ma1.0_nloop400000000.dat', delimiter=' ', skiprows = 3)
...
n_gen = 500            # Maximum Generation
tol = 1e-6              # Threshold to terminate the evolution
output_type = f'compressible{s}'     # Name of the problem
